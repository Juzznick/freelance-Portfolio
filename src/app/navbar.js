        ...
        <nav className="bg-white flex justify-center items-center pt-2 h-screen w-1/6 sticky top-0 z-999 ">
            <div className="bg-primary/50 h-29/30 w-9/10 rounded-2xl flex flex-col items-center justify-center overflow-hidden relative">
                ...
                <ul className="flex flex-col items-center w-full">
                    ...
                    <a href='/Nida_Shirin_Resume.pdf' className="w-full flex bg-cyan-200 justify-center items-center h-13 m-1 shadow-[inset_0px_0px_38px_-1px_rgba(236,_72,_153,_0.5)]"><li className="cursor-pointer text-2xl  text-white">My Resume</li></a>
                </ul>
            </div>
        </nav>
